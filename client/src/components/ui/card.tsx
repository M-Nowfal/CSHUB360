...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "text-card-foreground flex flex-col gap-2 rounded-xl border dark:border-slate-800 shadow-sm dark:shadow-slate-900/80 hover:shadow-lg transition-all duration-300",
        className
      )}
      {...props}
    />
